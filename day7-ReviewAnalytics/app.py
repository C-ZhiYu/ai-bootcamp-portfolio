...
# Import custom configurations and service functions
import config
...
if st.session_state.view_mode == "view_past" and st.session_state.selected_summary_id is not None:
    ...
    st.caption(f"Cloud Architecture Backend: **{config.GEMINI_MODEL}**")
    st.markdown("---")
