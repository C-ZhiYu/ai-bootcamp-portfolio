...
def analyse_keyword_match(resume_profile: dict, jd_profile: dict) -> dict:
    ...
    """
    # TODO: implement this function
    return ask_json(KEYWORD_MATCH_PROMPT, f"RÉSUMÉ PROFILE:\n{json.dumps(resume_profile, indent=2)}\n\nJD PROFILE:\n{json.dumps(jd_profile, indent=2)}", max_tokens=3000)
...
def analyse_jargon(
    ...
    """
    # TODO: implement this function
    return ask_json(JARGON_AUDIT_PROMPT, f"RÉSUMÉ PROFILE:\n{json.dumps(resume_profile, indent=2)}\n\nJD PROFILE:\n{json.dumps(jd_profile, indent=2)}", max_tokens=1500)
...
def analyse_background_fit(resume_profile: dict, jd_profile: dict) -> dict:
    ...
    """
    # TODO: implement this function
    return ask_json(BACKGROUND_FIT_PROMPT, f"RÉSUMÉ PROFILE:\n{json.dumps(resume_profile, indent=2)}\n\nJD PROFILE:\n{json.dumps(jd_profile, indent=2)}", max_tokens=600)
...
def compute_overall_score(report: dict) -> int:
    ...
    keyword = report.get("keyword_match", {}).get("keyword_match_score", 0)
